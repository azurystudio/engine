...
// @ts-nocheck deno-lint-ignore-file deno-fmt-ignore-file
// copy of https://cdn.jsdelivr.net/npm/realm-web@2.0.0/types/realm/services.d.ts
...
type Binary = import('https://esm.sh/bson@5.0.1').Binary
type Long = import('https://esm.sh/bson@5.0.1').Long
type Timestamp = import('https://esm.sh/bson@5.0.1').Timestamp
...
declare namespace Realm {
  ...
  namespace Services {
    ...
    namespace MongoDB {
       ...
       */
      type NewDocument<T extends Document> =
        & Omit<T, '_id'>
        & Partial<Pick<T, '_id'>>
